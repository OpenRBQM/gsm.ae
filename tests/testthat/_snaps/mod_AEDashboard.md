# mod_AEDashboard_UI produces the expected UI
    ...
    Code
      test_result
    Output
      <bslib-layout-columns class="bslib-grid grid bslib-mb-spacing html-fill-item" col-widths-sm="6,6,6,6" data-require-bs-caller="layout_columns()" data-require-bs-version="5">
...
# mod_AEDashboard_Server works as expected
    ...
    Output
      ...
      <td headers="stub_1_1 Study" class="gt_row gt_center" style="white-space: nowrap;">1,168 (+18)</td></tr>
          <tr><th id="stub_1_2" scope="row" class="gt_row gt_right gt_stub">AE Rate</th>
      <td headers="stub_1_2 Study" class="gt_row gt_center gt_striped" style="white-space: nowrap;">0.0071 (+0.0001)</td></tr>
      ...
      <script>gtShinyBinding.initialize('testing-summary-table');</script>
...
---
    ...
    Output
      ...
      #gtRandomID div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
        ...
        <tbody class="gt_table_body">
          <tr><th id="stub_1_1" scope="row" class="gt_row gt_right gt_stub">AE</th>
      <td headers="stub_1_1 Study" class="gt_row gt_center" style="white-space: nowrap;">1,150 (+88)</td></tr>
          <tr><th id="stub_1_2" scope="row" class="gt_row gt_right gt_stub">AE Rate</th>
      <td headers="stub_1_2 Study" class="gt_row gt_center gt_striped" style="white-space: nowrap;">0.0070 (+0.0006)</td></tr>
          <tr><th id="stub_1_3" scope="row" class="gt_row gt_right gt_stub">SAE</th>
