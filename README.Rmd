...
::: {.pkgdown-release}
You can explore a sample app produced by the latest release of gsm.ae [here](https://rinpharma.shinyapps.io/gsm-ae).
:::
::: {.pkgdown-devel}
You can explore a sample app produced by the development version of gsm.ae [here](https://rinpharma.shinyapps.io/gsm-ae-dev).
:::
